...
<div class="col-md-12">
  ...
  <div class="post_commentbox"> <a href="#"><i class="fa fa-user"></i><?php echo $row_ChiTietBaiViet['Name'] ?></a> <span><i class="fa fa-calendar"></i><?php echo $row_ChiTietBaiViet['Day'];
                                                                                                                                                        echo " ";
                                                                                                                                                        echo $row_ChiTietBaiViet['Time'] ?></span> <a href="#"><i class="fa fa-tags"></i><?php echo $row_category2['CategoryName'] ?></a> </div>
